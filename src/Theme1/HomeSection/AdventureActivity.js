  ...
  return (
    <>
      <div className="adac--container">
        <Container>
          <h1 className="sections--header ">Adventure And Activity</h1>
          <p className="p--header">
            Mollit voluptatem convallis elementum corporis quo veritatis aliquid
            blandit, blandit torquent, odit placeat. Adipiscing repudiandae eius
            cursus? Nostrum magnis maxime curae placeat.
          </p>
          <div className="adac--wrapper">
            <Grid container>
              <Grid sx={{ padding: "0px 9px" }} lg={2} xs={2}>
